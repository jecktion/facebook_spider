...
class auto(object):
    def autossh(self,ip):
        print (ip)
        k = paramiko.RSAKey.from_private_key_file("C:/Users/WGS/Desktop/yufei.pem")
    ...
    def autoip(self):
        ...
        email = "wanggs_wkyx@163.com"
        password = "WGS7968463mmm"
        try:
